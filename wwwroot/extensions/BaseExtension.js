export class BaseExtension extends Autodesk.Viewing.Extension {
  ...
  createToolbarButton(buttonId, buttonIconUrl, buttonTooltip) {
    let group = this.viewer.toolbar.getControl("dashboard-group");
    if (!group) {
      group = new Autodesk.Viewing.UI.ControlGroup("dashboard-group");
  ...
  removeToolbarButton(button) {
    const group = this.viewer.toolbar.getControl("dashboard-group");
    if (group) {
